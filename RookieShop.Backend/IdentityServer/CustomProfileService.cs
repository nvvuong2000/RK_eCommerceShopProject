...
namespace RookieShop.Backend.IdentityServer
{
    public class CustomProfileService : IProfileService
    {
        ...
        public CustomProfileService(UserManager<User> userManager,
            ILogger<CustomProfileService> logger, ApplicationDbContext db)
        {
            _logger = logger;
        ...
        public async Task GetProfileDataAsync(ProfileDataRequestContext context)
        {
            ...
            {
                //var userName = this.HttpContext.User.Identity.Claims.First(claim => claim.Type == JwtClaimTypes.Name).Value;
